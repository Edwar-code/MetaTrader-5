...
export function DerivProvider({ children }: { children: ReactNode }) {
    ...
    useEffect(() => {
        // This effect will only run if there is an activeToken
        if (!activeToken) {
    ...
    }, [activeToken, toast, disconnect, stableHandleContractUpdate, stableHandleTransactionUpdate, connectionState]);
