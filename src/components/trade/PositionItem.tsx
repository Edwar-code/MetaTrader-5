...
export default function PositionItem({ position }: PositionItemProps) {
  ...
  const typeColor = position.type === 'BUY' ? '#3082ff' : '#FF3B30';
                ...
                <div className="flex items-center gap-1 leading-none">
                  {isGold ? (
                    <div className="flex items-baseline">
                      <Image src="https://on98bvtkqbnonyxs.public.blob.vercel-storage.com/WhatsApp%20Image%202025-08-21%20at%2012.33.35_e00bef8a.jpg" alt="XAUUSD" width={50} height={9} className="object-contain" style={{ position: 'relative', top: '1.5px' }} />
