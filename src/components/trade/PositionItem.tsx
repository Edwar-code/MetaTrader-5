        ...
        <div className="flex items-center justify-between">
            <div className="flex-1">
                <div className="flex gap-1 leading-none">
                  {isGold ? (
                    <div className="flex">
                      <Image src="https://on98bvtkqbnonyxs.public.blob.vercel-storage.com/WhatsApp%20Image%202025-08-21%20at%2012.33.35_e00bef8a.jpg" alt="XAUUSD" width={50} height={9} className="object-contain" style={{ position: 'relative', top: '6px' }} />
