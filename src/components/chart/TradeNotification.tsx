...
const TradeNotification = ({ tradeDetails, onClose }: TradeNotificationProps) => {
  ...
  return (
    <div 
      className="absolute bottom-24 left-1/2 flex items-center bg-white shadow-lg animate-slide-in-bottom z-50"
    ...
    >
      ...
      <div className="flex items-center text-sm pr-4">
        ...
        <span className="font-normal text-gray-800 mr-[17px]">{size.toFixed(2)}</span>
