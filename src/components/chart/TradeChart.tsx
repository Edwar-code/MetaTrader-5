...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    ...
    const priceDecimalPoints = data.symbol === 'frxXAUUSD' || data.symbol === 'cryBTCUSD' || data.symbol === 'idxDE30' ? 2 : 5;
...
const OrderPriceLabel = ({ viewBox, value, tradeType, asset }: any) => {
    ...
    const color = tradeType === 'BUY' ? '#007AFF' : '#FF3B30';
    const priceDecimalPoints = asset === 'frxXAUUSD' || asset === 'cryBTCUSD' || asset === 'idxDE30' ? 2 : 5;
